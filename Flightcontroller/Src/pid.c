...
void calculate_pid()
{
  ...
  pid_roll_setpoint = 0;
	...
	if(channel[0] > 1508)pid_roll_setpoint = channel[0] - 1508;
	else if(channel[0] < 1492)pid_roll_setpoint = channel[0] - 1492;
	...
	//We need a little dead band of 16us for better results.
	if(channel[1] > 1508)pid_pitch_setpoint = channel[1] - 1508;
	else if(channel[1] < 1492)pid_pitch_setpoint = channel[1] - 1492;
